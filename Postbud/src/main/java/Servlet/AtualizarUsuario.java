...
public class AtualizarUsuario extends HttpServlet {
    ...
    Usuario usuario = (Usuario) request.getSession(true).getAttribute("usuarioAtual");
        UsuarioDAO usuao = new UsuarioDAO();
    ...
    usuao.updateUsuario(usuario.getEmail(), senha, nome, email, sobrenome);

            // aí, depois de atualizar, vc recarrega a list na sessão http:
   List<Usuario> usuarios = usuao.listUsuario();
