...
import hibernatePersistence.usuario.Usuario;
import hibernatePersistence.usuario.UsuarioDAO;
...
public class Login extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            user = dao.getUsuario(email, senha);
        }
        catch (Exception e)
        {
        ...
        if (user != null)
        {
           ...
           // session.getAttribute("nomeperturbador");
